...
import { Github, Linkedin, Mail, Download, BrainCircuit, Eye, Code, FileText, Bot, Briefcase, Star, X, Zap, Target, Trophy, BookOpen, ChevronsRight } from 'lucide-react';
...
const experienceData = [
    {
        ...
        points: [
            "Improved object detection and pose estimation accuracy by 20% using YOLO, ByteTrack, and Kalman filters.",
            "Accelerated inference speed on NVIDIA edge devices using TensorRT and ONNX.",
            "Developed and deployed scalable, Dockerized solutions in a production environment."
        ]
    },
    {
        ...
        points: [
            "Led avionics for an autonomous lane-following system using OpenCV and TensorFlow.",
            "Developed a real-time facial tracking system on a UAV to automate camera-work for online lectures.",
            "Secured 3rd place as team lead in an inter-university Robot Soccer Competition."
        ]
    }
];
...
const achievementsData = [
    { title: "Flipkart Grid Robotics Challenge", detail: "National Finalist (Top 10 of 19,000+ teams)", icon: <Trophy color="#FFD700" /> },
    { title: "International Micro Aerial Vehicle (IMAV)", detail: "3rd Place Worldwide, Aachen, Germany", icon: <Trophy color="#C0C0C0" /> },
...
const skillsData = {
    ...
    "Core Concepts": ["LLM Fine-tuning", "RAG", "Quantization", "Mixture of Experts", "Attention Mechanisms", "Object Detection"],
};
...
export default function Portfolio() {
  ...
  useEffect(() => {
    // Add a fallback for project images
    projectsData.forEach(p => {
        if (!p.image.includes('placeholder')) {
            const img = new window.Image();
            img.src = p.image;
            img.onerror = () => {
                p.image = 'https://placehold.co/400x225/1F2937/7DD3FC?text=Image+Not+Found';
            }
        }
    });
    setMounted(true);
